...
<div id="content">
    <div class="login">
        <div class="container">
            <div class="profile">
                <div class="title"><strong>Welcome To</strong> {{$jobdetails->school_name}}</div>
                <div class="p_row clearfix">
                    ...
                    <div class="half">
                        <form method="POST" autocomplete="off" name="admissionForm" id="admissionForm" action="{{route('jobapply', ['id' => $jobdetails->id])}}" enctype="multipart/form-data">
                            @csrf                       
                            <div class="row clearfix">
                                ...
                                <div class="part">
                                    <label>For which subject*</label>
                                    <input type="text" class="input_text"name="subject" id="fathername">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="part">
                                    <label>From which Standart*</label>
                                    <input type="text" class="input_text" name="minclass" id="mothername">
                                </div>
                                <div class="part">
                                    <label>To which Standart*</label>
                                    <input type="text" class="input_text" name="maxclass" id="class">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="part">
